...
namespace WindowsFormsApp1
{
    class ReaderHelper : SQLFunction
    {
        ...
        public ReaderHelper(string ID, string Name, string number, int Rcategoryid)
        {
            ReaderID = ID;
            ReaderName = Name;
        ...
        public void Insert()
        {
            string str1 = " Rid," + "Rname," + "Rcategoryid," + "Phone";
            string str2 = "'" + ReaderID + "'," + "'" + ReaderName + "'," + Rcategoryid + "," + "'" + ReaderPhoneNumber + "'";
